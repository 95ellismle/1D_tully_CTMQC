...
class CTMQC(object):
    ...
    def __calc_quantities(self, irep, v):
        """
    ...
    def __main_loop(self):
        ...
        for istep in range(nstep):
            try:
                ...
                self.allTimes.append(t2 - t1)
                avgTime = np.mean(self.allTimes)
    ...
    def __finalise(self):
        ...
        msg += "  Avg. Time Per Step = %.2gs" % np.mean(self.allTimes)
        msg += "  All Done!\n***\n"
#            print(" "*200, end="\r")
        print(msg)
